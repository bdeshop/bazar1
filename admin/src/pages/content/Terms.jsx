...
const Terms = () => {
  ...
  const handleRestoreVersion = async (versionId) => {
    if (window.confirm('Are you sure you want to restore this version? This will replace your current terms and conditions.')) {
      try {
        setLoading(true);
        await axios.post(`${base_url}/api/admin/terms/restore/${versionId}`);
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div className="flex space-x-2">
                              <button 
                                ...
                                className="px-3 py-1.5 bg-blue-500 text-white rounded-md hover:bg-blue-600 flex items-center transition-colors duration-200 shadow-sm"
                                disabled={loading}
                              >
                              ...
                              <button 
                                ...
                                className="px-3 py-1.5 bg-red-500 text-white rounded-md hover:bg-red-600 flex items-center transition-colors duration-200 shadow-sm"
                                disabled={loading}
                              >
                                <FaTimes className="mr-1 text-xs" /> Restore
                              </button>
                            </div>
                          </td>
                        </tr>
