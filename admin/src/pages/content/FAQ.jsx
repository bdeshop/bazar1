...
import { FaPlus, FaEdit, FaTrash, FaChevronDown, FaChevronUp, FaSpinner } from 'react-icons/fa';
                              ...
                              <div className="p-4 border-t border-gray-200 bg-gray-50">
                                ...
                                <div className="mt-3 flex space-x-2">
                                  <button 
                                    ...
                                    className="px-3 py-1 text-white bg-blue-600 cursor-pointer rounded-[3px] text-sm flex items-center"
                                  >
                                    <FaEdit className="mr-1" /> Edit
                                  </button>
                                  <button 
                                    onClick={() => deleteFaq(faq._id)}
                                    className="px-3 py-1 text-white bg-red-600 cursor-pointer rounded-[3px] text-sm flex items-center"
                                  >
