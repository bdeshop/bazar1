...
const Home = () => {
  ...
  const [affiliateDropdown, setAffiliateDropdown] = useState(false); // New state for dropdown
  ...
  const menuItems = [
    ...
    { label: 'Tools', href: '#tools' },
    {
      ...
      dropdown: true,
      subItems: [
        { label: 'Super Affiliate', href: '#super-affiliate' },
        { label: 'Master Affiliate', href: '#master-affiliate' },
      ],
    },
    { label: 'FAQ', href: '#faq' },
  ...
  const faqData = [
    {
      question: "How do I join the BajiLive Affiliate Program?",
  ...
  const testimonialData = [
    {
      ...
      quote: "BajiLive's affiliate program has been a game-changer! The high commissions and real-time tracking make it easy to earn big.",
  ...
  return (
    <div className="min-h-screen bg-[#141515] font-nunito text-gray-100">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              <img
                src="https://img.b112j.com/bj/h5/assets/v3/images/logo.png?v=1760527477748&source=drccdnsrc"
                alt="BajiLive Affiliate"
            ...
            <div className="md:test-hidden mt-4 pb-4 bg-[#1a1b1b]">
              <div className="flex flex-col space-y-4 px-4">
                ...
                <div className="flex space-x-4 pt-2">
                  <button className="bg-[#2a2b2b] text-gray-300 px-5 py-2 rounded-lg font-semibold hover:bg-[#3a3b3b] transition duration-300 flex items-center space-x-2 flex-1 justify-center border border-gray-700">
                    <span>Login</span>
                  </button>
                  <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-5 py-2 rounded-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition duration-300 flex items-center space-x-2 flex-1 justify-center">
                    <span>Sign Up</span>
                  </button>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 h-full gap-12 items-center">
            <div className="text-left">
              <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-blue-500 leading-tight">
                Join BajiLive Affiliate Program
              </h1>
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl">
                Unlock unlimited earning potential by promoting BajiLive. Start today and turn your audience into profit!
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:from-purple-700 hover:to-blue-700 transition duration-300 shadow-lg">
            ...
            <div className="flex justify-center">
              <img
                ...
                alt="BajiLive Affiliate Program"
      ...
      <section id="why-partner" className="py-20 bg-[#141515]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-100 mb-4">Why Partner with BajiLive?</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Discover why thousands of affiliates choose BajiLive for unmatched earning potential.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#2a2b2b] p-8 rounded-lg border border-red-500/20">
              ...
              <p className="text-gray-300">Earn equity in BajiLive for top performers.</p>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center p-12">
            ...
            <p className="text-xl text-gray-400 mb-8">
              Leverage cutting-edge technology and unmatched earning potential with BajiLive.
            </p>
            <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:from-purple-700 hover:to-blue-700 transition duration-300 shadow-lg">
              Start Earning Today
            </button>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                <img
                  src="https://bajiliveaffiliate.com/wp-content/uploads/2023/08/bjaff-logo2-e1708094785566.png"
                  alt="BajiLive Affiliate"
                  className="h-12 w-auto"
                />
              </div>
              <p className="text-gray-400 mb-4 max-w-md">
                Join BajiLive Affiliate and turn your audience into income with our premium services and generous commissions.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-400">affiliate@bajilive.com</span>
                </li>
                <li className="flex items-center space-x-3">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © 2025 BajiLive Affiliate Program. All rights reserved.
            </p>
