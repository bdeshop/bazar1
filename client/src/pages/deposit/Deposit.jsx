  ...
  return (
    <div className="h-screen overflow-hidden bg-[#0f1a1a] text-white font-rubik">
      ...
      <div className="flex h-[calc(100vh-56px)]">
        ...
        <div
          className={`flex-1 overflow-auto transition-all duration-300 p-3 md:p-6 ${
        ...
        >
          <div className="max-w-6xl mx-auto py-4 md:py-8">
            <div className="mb-6 md:mb-8">
              ...
              <p className="text-sm md:text-base text-[#9ab]">
            ...
            <div className="bg-gradient-to-r from-[#0d3529] to-[#1a5e4a] rounded-[2px] p-4 md:p-6 mb-6 md:mb-8 shadow-lg border border-[#2a4a3e]">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-0">
                <div>
                  <p className="text-xs md:text-sm text-[#c8e6d0]">
                    Current Balance
                  </p>
            ...
            <div className="bg-[#1a2e2a] rounded-[2px] overflow-hidden mb-6 md:mb-8 border border-[#2a4a3e]">
              ...
              <div className="p-4 md:p-6 border-t border-[#2a4a3e]">
                <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-white flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4 md:h-5 md:w-5 mr-2 text-[#2dc18f]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-1 gap-6 md:gap-8">
              ...
              <div className="bg-[#1a2e2a] rounded-[2px] p-4 md:p-6 border border-[#2a4a3e]">
                ...
                <ol className="text-xs md:text-sm text-[#9ab] space-y-2 md:space-y-3 list-decimal list-inside">
                  ...
                  <li>
                    Wait for confirmation message (usually within seconds)
                  </li>
                  ...
                  userData.depositHistory.length > 0 ? (
                    <div className="space-y-3 md:space-y-4">
                      {userData.depositHistory.map((transaction, index) => (
                        <div
                          key={index}
                          className="flex justify-between items-center p-3 bg-[#1f3b34] rounded-lg hover:bg-[#24443c] transition-colors"
                        >
                          <div className="flex items-center">
                            <div
                              className={`p-1.5 md:p-2 rounded-full mr-2 md:mr-3 ${
                                transaction.status === "completed"
                                  ? "bg-[#1a3b2b] text-[#4ecdc4]"
                                  : transaction.status === "pending"
                                  ? "bg-[#3b3a1a] text-[#e6db74]"
                            ...
                            <div>
                              ...
                              <p className="text-xs text-[#9ab] capitalize">
                                {transaction.method}
                              </p>
                            </div>
                          </div>
