    ...
    <div className="h-screen overflow-hidden font-poppins bg-[#1a1a1a] text-white">
      ...
      <div className="flex h-[calc(100vh-56px)]">
        ...
        <div className="w-full">
          <div className="mx-auto w-full overflow-y-auto min-h-screen max-w-screen-xl md:px-4 py-4">
            {/* Top Section */}
            <div className="flex flex-col sm:flex-row items-center justify-between pt-[30px] md:pt-[60px] mb-6 gap-4">
