      ...
      <div className="bg-[#1a1a1a] px-2 pt-6 md:p-4 font-inter text-gray-200">
        ...
        >
          {featuredGames.map((game, index) => (
            <div
              key={game._id || index}
              className="flex-shrink-0 w-40 md:w-[200px] flex flex-col items-center justify-center p-1.5 md:p-2 snap-center transform transition-transform duration-200 hover:scale-105 cursor-pointer relative group"
