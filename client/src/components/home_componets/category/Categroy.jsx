...
const CategoryContent = () => {
  ...
  const setExclusiveCategoryAsActive = (categories) => {
    ...
    if (exclusiveCategory) {
      ...
      // Always fetch exclusive games for the first tab
      fetchExclusiveGames(exclusiveCategory.name);
    }
  };
  ...
  useEffect(() => {
    const initializeData = async () => {
      ...
      if (categoriesCache) {
        ...
        setExclusiveCategoryAsActive(sortedCategories);
        setLoading(false);
        return;
      }
