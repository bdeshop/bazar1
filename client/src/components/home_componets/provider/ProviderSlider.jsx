        ...
        >
          {providers.length > 0 ? (
            providers.map((provider, index) => (
              <div
                key={index}
                className="flex-shrink-0 md:w-40 md:h-20 bg-box_bg flex rounded-[3px] items-center justify-between gap-4 p-2 snap-center transform transition-transform duration-200 hover:scale-105 cursor-pointer"
              >
                <img
