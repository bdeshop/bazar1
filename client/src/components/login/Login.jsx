...
export default function Login() {
  ...
  const [isSignUpActive, setIsSignUpActive] = useState(false); // Changed to false to make login active
        ...
        <div className="w-full px-[10px] md:px-0 md:max-w-lg bg-opacity-80 overflow-hidden">
          ...
          <div className="py-4 md:py-6">
            ...
            {isSignUpActive ? (
              <>
                ...
                {currentStep === 1 && (
                  <form onSubmit={handleSignUpStep1}>
                    {/* Currency Dropdown */}
                    <div className="mb-4 ">
                      <label htmlFor="currency" className="block text-xs md:text-sm text-gray-400 mb-2 font-[300]">Choose currency</label>
                      <div className="relative">
                        <select
                          id="currency"
                          value={currency}
                          onChange={(e) => setCurrency(e.target.value)}
                          className="w-full p-2 md:p-3 text-sm md:text-base bg-[#141515] font-[300] border-[1px] border-gray-900 text-white appearance-none cursor-pointer outline-none"
                        >
                    ...
                    {/* Phone Number Input */}
                    <div className="mb-4">
                      <label htmlFor="phone" className="block text-xs md:text-sm text-gray-400 mb-2 font-[300]">Phone number</label>
                      <div className="flex items-stretch bg-[#141515] border-[1px] border-gray-900 ">
                        {/* Country Code with Flag */}
                        <div className="flex items-center px-2 md:px-3 bg-[#141515] rounded-l border-r border-gray-800">
                    ...
                    <div className="mb-4">
                      <label htmlFor="referralCode" className="block text-xs md:text-sm font-[300] text-gray-400 mb-2">
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 p-2 md:p-3 text-sm bg-[#141515] font-[300] border-[1px] border-gray-900 text-white rounded focus:outline-none"
                  ...
                  <form onSubmit={handleSignUpStep2}>
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        className="w-full p-2 md:p-3 text-sm bg-[#141515] font-[300] border-[1px] border-gray-900 text-white rounded focus:outline-none"
                  ...
                  <form onSubmit={handleSignUpStep3}>
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        className="w-full p-2 md:p-3 text-sm font-[300]  bg-[#141515] border-[1px] border-gray-900 text-white rounded outline-none"
                    ...
                    <button
                      type="submit"
                      className="w-full py-2 md:py-3 bg-theme_color cursor-pointer text-white text-sm font-[300]  mt-2 shadow-lg transition-transform transform hover:scale-[1.02] disabled:opacity-50"
                      disabled={isLoading}
                    >
              ...
              /* Login Form - Now active by default */
              <>
                <form onSubmit={handleLoginSubmit}>
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      className="w-full p-2 md:p-3 text-sm font-[300]  bg-[#141515] border-[1px] border-gray-900 text-white rounded focus:outline-none"
                      placeholder="Enter your username"
                      disabled={isLoading}
                    />
                  </div>
                  ...
                  <div className="mb-4 md:mb-6">
                    ...
                    <input
                      ...
                      value={password}
                      onChange={(e) => setPassword(e.target.value)}
                      className="w-full p-2 md:p-3 text-sm font-[300]  bg-[#141515] font-[300] border-[1px] border-gray-900 text-white rounded focus:outline-none"
                  ...
                  <button
                    type="submit"
                    className="w-full py-2 md:py-3 bg-theme_color cursor-pointer text-white text-sm font-[300]  shadow-lg transition-transform transform hover:scale-[1.02] disabled:opacity-50"
                    disabled={isLoading}
                  >
