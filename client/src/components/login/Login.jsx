...
export default function Register() {
  ...
  const [isSignUpActive, setIsSignUpActive] = useState(false); // Changed to false to make Log in tab active
              ...
              <>
                ...
                {currentStep === 1 && (
                  <form onSubmit={handleSignUpStep1}>
                      ...
                      <div className="flex gap-2">
                        ...
                        {referralValid && (
                          <button
                            ...
                            className="px-3 md:px-4 bg-red-600 text-white rounded text-sm font-medium"
                          >
                            Change
                          </button>
                        )}
                    ...
                    <button
                      type="submit"
                      className="w-full py-2 md:py-3 bg-theme_color text-white cursor-pointer text-sm md:text-base font-[600] mt-4 rounded shadow-lg transition-transform transform hover:scale-[1.02] disabled:opacity-50"
                      disabled={isLoading}
                    >
                ...
                <form onSubmit={handleLoginSubmit}>
                  ...
                  <div className="flex justify-between items-center mb-4 md:mb-6">
                    <label className="flex items-center text-xs md:text-sm text-gray-400">
                      <input 
                        type="checkbox" 
                        className="form-checkbox h-4 w-4 text-green-500 bg-gray-800 border-gray-700" 
                        disabled={isLoading}
                      />
                  ...
                  <button
                    type="submit"
                    className="w-full py-2 md:py-3 bg-theme_color cursor-pointer text-white text-sm md:text-base font-[600] shadow-lg transition-transform transform hover:scale-[1.02] disabled:opacity-50"
                    disabled={isLoading}
                  >
