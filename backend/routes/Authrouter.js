    ...
    try {
      ...
      if (affiliateCode) {
        ...
        if (affiliate) {
          ...
          const registrationBonus = affiliate.cpaRate; // Example: 50 BDT for registration
          ...
          const overrideRate = masterAffiliate.masterEarnings.overrideCommission / 100;
          const overrideAmount = masterAffiliate.cpaRate;
